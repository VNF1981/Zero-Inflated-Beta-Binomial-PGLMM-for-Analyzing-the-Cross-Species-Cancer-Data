...
This repository contains an R script for running a Bayesian assurance analysis for a fitted zero inflated beta binomial phylogenetic generalized linear mixed model.
