...
This repository contains an R script for running a Bayesian assurance analysis for a fitted ZiBBPGLMM. The general idea for this simulation-based analysis is adapted from [bayesassurance](https://journal.r-project.org/articles/RJ-2023-066/) R package. I will soon expand this framework to Gompertzian models as well. 
